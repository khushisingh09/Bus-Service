        ...
        <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0">
          ...
          <div className="md:w-1/3 text-center">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 text-2xl hover:text-gray-800">Home</a></li>
              <li><a href="#" className="text-gray-600 text-2xl hover:text-gray-800">Service</a></li>
              <li><a href="#" className="text-gray-600 text-2xl hover:text-gray-800">About</a></li>
            </ul>
          </div>

          {/* Bus Service Company Section */}
          <div className="md:w-1/3 text-right">
            <h3 className="text-3xl font-bold mb-4">Bus Service Company</h3>
